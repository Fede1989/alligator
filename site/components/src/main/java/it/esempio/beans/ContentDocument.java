...
@HippoEssentialsGenerated(internalName = "alligator:contentdocument")
@Node(jcrType = "alligator:contentdocument")
public class ContentDocument extends BaseDocument {
    ...
    @HippoEssentialsGenerated(internalName = "alligator:publicationdate")
    public Calendar getPublicationDate() {
        return getSingleProperty("alligator:publicationdate");
    }
}
